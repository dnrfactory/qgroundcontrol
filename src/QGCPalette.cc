...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(window,               "#ffffff", "#ffffff", "#222222", "#161C41")
    DECLARE_QGC_COLOR(windowShadeLight,     "#909090", "#828282", "#707070", "#626262")
    DECLARE_QGC_COLOR(windowShade,          "#d9d9d9", "#d9d9d9", "#333333", "#313A70")
    ...
    DECLARE_QGC_COLOR(button,               "#D9D9D9", "#313A70", "#D9D9D9", "#313A70")
    DECLARE_QGC_COLOR(buttonText,           "#9d9d9d", "#000000", "#A6A6A6", "#ffffff")
    DECLARE_QGC_COLOR(buttonHighlight,      "#313A70", "#F49F26", "#313A70", "#F49F26")
    ...
    DECLARE_QGC_COLOR(toolbarBackground,    "#ffffff", "#ffffff", "#222222", "#161C41")
    ...
    DECLARE_QGC_SINGLE_COLOR(customMainToolBarButton,       "#313A70")
}
